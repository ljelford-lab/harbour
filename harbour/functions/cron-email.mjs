...
// can't be triggered by a public URL at all (Netlify blocks that), so
// there's no separate secret needed to protect this one from outside
// callers — unlike week.mjs / weeks-index.mjs which the browser calls
// directly and so need the HARBOUR_SECRET check.
import { Resend } from 'resend';
import { getWeek } from './lib/_store.mjs';
